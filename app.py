...
def _find_model_path():
    ...
    candidates = [
        ...
        Path(r"D:\project\data\raw\CKD_API") / MODEL_FILENAME,
        Path(r"D:\project\data\raw\CKD") / MODEL_FILENAME,
        Path(r"D:\project\data\raw") / MODEL_FILENAME,
    ]
...
def _candidate_files(names):
    ...
    roots = [
        ...
        Path(r"D:\project\data\raw\CKD"),
        Path(r"D:\project\data\raw")
    ]
    found = []
    for root in roots:
        for name in names:
